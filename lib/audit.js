...
function logScan(repoRoot, { hookType, files, findings, blocked, exceptions_applied, scanId }) {
  ...
  // This is fire-and-forget — queue write failure never affects scan output.
  try {
