...
// Storage stays UTC ISO-8601; human output shows local time (2026-06-05 rule).
// No shared formatLocalTime helper exists yet (its own post-pilot TODO) — a
// minimal inline local format is used here rather than printing raw UTC.
