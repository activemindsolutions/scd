...
function register(program) {
  ...
  program
    ...
    .action(async (targets, opts) => {
      ...
      if (skipLogging) console.log(`${YELLOW} ↷ Results not saved — target is outside any known repository${RESET}`);
      console.log();
      ...
      if (process.stderr.isTTY) process.stderr.write('\r' + DIM + ' Saving results…' + RESET);
