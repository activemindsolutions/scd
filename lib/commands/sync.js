...
function register(program) {
  program
    ...
    .action(async (opts) => {
      ...
      // Push first, then pull — surface any local exceptions to the server
      // before fetching status updates. Quiet on failure: same offline-first
      // philosophy as the event push queue.
