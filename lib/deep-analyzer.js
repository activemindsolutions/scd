/**
 * deep-analyzer.js
 * Claude API-driven deep analysis of security findings from scd scan --deep.
 *
 * Design:
...
async function deepAnalyze(findings, opts = {}) {
  ...
  if (!apiKey) {
    throw new Error(
      'ANTHROPIC_API_KEY missing. Set the key in environment or run: scd configure --api-key sk-ant-...'
    );
  }
