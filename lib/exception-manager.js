 ...
 *
 * Usage: scd approve --rule FRONT-001 --file src/maps/config.js --line 12
 *
...
async function addException(repoRoot, opts) {
  ...
  if (!rule || !file || !line) {
    console.log('\n\x1b[31mUsage: scd approve --rule <id> --file <path> --line <n>\x1b[0m\n');
    process.exit(1);
  }
  ...
  if (fs.existsSync(filePath)) {
    ...
    console.log(`\x1b[33mFile not found locally – exception created without hash\x1b[0m`);
  }
