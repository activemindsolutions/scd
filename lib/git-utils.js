    ...
    for (const filePath of filePaths) {
      try {
        if (hookType === 'pre-commit') {
          ...
          // Array-form execFileSync — never a shell — so a filename containing shell
          // metacharacters (a hostile/AI-generated repo) cannot inject commands.
          const content = execFileSync('git', ['show', ':' + filePath], { encoding: 'utf8' });
