...
# Left commented so the global default applies. Uncomment to PIN a per-repo level
# (a pinned value overrides a stricter global — set deliberately): scd configure --trust-level
