...
const CLI_PATH = path.resolve(__dirname, '../bin/security-copilot.js');

const PRE_COMMIT_HOOK = `#!/bin/sh
# Security Copilot – pre-commit hook
# Scans for secrets BEFORE they enter git history
# Installed by: security-copilot install
...
# Security Copilot – pre-push hook
...
async function install() {
  console.log('\n\x1b[36m Security Copilot – Installation\x1b[0m\n');
