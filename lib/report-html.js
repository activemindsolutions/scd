...
<head>
  ...
  <title>Security Report – ${escHtml(target)}</title>
...
<div class="page">
  ...
  <header class="report-header">
    <div>
      <div class="brand">
        ...
        <span class="brand-name">Security Co-Pilot</span>
      </div>
      <h1 class="report-title">Security Scan Report</h1>
      <div class="report-target mono">Target: ${escHtml(target)}</div>
    </div>
  ...
  <footer class="report-footer">
    <span>Generated by <strong>Security Co-Pilot v0.1.0</strong></span>
