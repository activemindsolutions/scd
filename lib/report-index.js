...
function buildCSS() {
  return [
    ...
    '    }',
    '    html { font-size: 15px; }',
    '    body { background: var(--bg); color: var(--text); font-family: \'Syne\', ui-sans-serif, system-ui, sans-serif;',
    ...
    '    .repo-path { font-family: \'JetBrains Mono\', ui-monospace, Menlo, Consolas, monospace; color: var(--muted);',
    ...
    '    .mono { font-family: \'JetBrains Mono\', ui-monospace, Menlo, Consolas, monospace; font-size: 0.82rem; }',
