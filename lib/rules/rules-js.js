...
const ERROR_RULES = [
  {
    ...
    why: 'Returning raw error objects or stack traces to the client reveals internal file paths, library versions, database schema details, and application logic. This information directly assists attackers in crafting targeted exploits.',
...
const SSRF_RULES = [
  {
    ...
    why: 'Passing user-supplied URLs to outbound HTTP requests allows attackers to make the server send requests to internal infrastructure — cloud metadata endpoints (169.254.169.254), internal s, admin panels, or other services not exposed to the internet.',
