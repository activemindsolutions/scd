...
function buildFinding(rule, filePath, lineNumber, snippet, lineRaw, config, taintInfo = null, matchObj = null) {
  ...
  const finding = {
    ...
    line:         lineNumber,
    snippet,
    // codeHash is content-based: sha256 of the raw line only (see CLAUDE.md "code_hash is
    // content-based"). Never includes filePath — survives line movement; filePath is already in
    // finding_id and the server identity tuple. Same algorithm in scanner-secrets.js.
